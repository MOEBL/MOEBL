...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo getUrlWithVersion("styles/main.css") ?>" media="screen" />
...
<div class="container">
    <div class="head">
        <div class="headleft">
            <a href="<?php echo $_SERVER["SCRIPT_NAME"] ?>">
                <img src="<?php echo getUrlWithVersion("images/home64.png") ?>" alt="Home" />
            </a>
        </div>
        <div class="headright">
    ...
    <div class="entries">
        ...
        <div class="book">
            ...
            <?php
                $i = 0;
                foreach ($config['moebl_html_prefered_format'] as $format)
                {
                    if ($i == 2) { break; }
            ...
            <div class="bookdetail">
                <a class="navigation" href="bookdetails.php?id=<?php echo $entry->book->id ?>" />
